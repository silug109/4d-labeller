...
class Bev_Canvas_2(pg.GraphicsView):
    ...
    #     self.pixmap = QPixmap()
        ...
        y_axis_item.setStyle(tickTextHeight=3, tickTextWidth=3)
        y_axis_item.linkToView(self.bev_view)
        x_axis_item = pg.AxisItem('left', showValues=False)
        x_axis_item.setStyle(tickTextHeight=3, tickTextWidth=3)
    ...
    #
    #     # self.print_all_coords()
    #     # self.save_created_bb()
    #     return bounding_box
...
class Bev_Canvas(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        super(Bev_Canvas, self).__init__(*args, **kwargs)
    #     # Initialise local state.
        self.mode = self.EDIT
        self.shapes = []
        self.current = None
    ...
    def load_radar(self):
        ...
        bev_item.setData(pos=self.load_bev_project())
        self.bev_widget.addItem(self.bev_view)
        self.bev_widget.setCentralWidget((self.bev_view))
        self.bev_view.addItem(bev_item)
    ...
    def mouseMoveEvent(self, ev):
        ...
        self.parent().change_status(''.join(["event in bev widget:", str(ev.pos().x()), " ", str(ev.pos().y())]))
        # self.parent().statusbar.showMessage(''.join(["event in bev widget:", ev.pos().x(), " ", ev.pos().y()]))
        # print("event in bev widget:", ev.pos().x(), " ", ev.pos().y())

    #     """Update line with last point and current coordinates."""
    #     pos = self.transformPos(ev.pos())
    #     self.info_label.setText(str(pos.x())+";"+str(pos.y()))
    #     print(str(pos.x()))
        # # Polygon drawing.
        # if self.drawing():
